...
const ProjectPage = ({ params }: { params: any }) => {
    ...
    const setCurrentWeeklyTask = (tasks: any) => {
        ...
        const weeklyTask = tasks.find(task => {
    ...
    return (
        <main className="mx-4 flex flex-col bg-content2 border-2 justify-between w-screen h-screen">
                {isAdmin && (
                    <div
                        className="flex flex-col admin-panel p-2 m-1 gap-3 bg-content1 border-inherit rounded-medium hover:m-0.5 transition-all duration-300">
                        ...
                        <div className="flex flex-col w-[50%] rounded-medium bg-content3 justify-start">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between text-2xl p-1">
                            ...
                            <div className="flex flex-row justify-between">
                                <p className="bg-content3 rounded-3xl border-1 gap-2 p-2 w-[80%]">{currentTask.description}</p>
                                <div className="flex flex-col items-end">
                                <div className="m-3">
                                        <span>Start: {formatDate(currentTask.start_time)}</span>
                                    </div>
                                    <div className="m-3">
