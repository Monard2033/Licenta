    ...
    return (
        <div className="p-4">
            ...
            >
                ...
                <Tab key="2" title="Sesiunea 2">
                    <Card id="session1">
                        <CardBody id="session 2">
                            <Table
                                id="session2"
                                isHeaderSticky
                                classNames={{
